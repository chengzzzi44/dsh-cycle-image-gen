...
![生成一只小狗：文生图](https://cdn.jsdelivr.net/gh/chengzzzi44/dsh-cycle-image-gen@main/docs/images/text-to-image.png)

**图生图** —— 把上一张图的路径填进 `image` 参数继续编辑，原图保留、新图另存：

![让小狗站起来戴上帽子：图生图](https://cdn.jsdelivr.net/gh/chengzzzi44/dsh-cycle-image-gen@main/docs/images/image-to-image.png)
